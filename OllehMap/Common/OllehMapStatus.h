...
#ifdef TB_SERVER
#define facebooksId @"1396728020583742"
#else
#define facebooksId @"170614009631423"
#endif
...
enum OMStatus_MapRenderType
{
    ...
    MapRenderType_SearchResult_RoadCode = 6
};
typedef enum
{
...
typedef struct
{
    __unsafe_unretained NSString *strID;
...
typedef struct
{
    ...
    int nEndID;
    int nStartID;
    __unsafe_unretained NSString *strStartName;
    __unsafe_unretained NSString *strEndName;
    __unsafe_unretained NSString *strLaneName;
    int nMethodType;
    int nRgType;
    Coord crd;
...
@interface OllehMapStatus : NSObject
{
    ...
    NSMutableDictionary *_prevSearchLocalDictionary;
    ...
    // 도로명 정보
    NSMutableDictionary *_roadNameDictionary;
    // 단말기 정보
...
@property (nonatomic, retain) NSMutableDictionary *prevSearchLocalDictionary;
...
@property (nonatomic, retain) NSMutableDictionary *roadNameDictionary;
