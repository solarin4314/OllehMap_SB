...
- (void) pushViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    ...
    if ( [viewController isKindOfClass:[BusStationPOIDetailViewController class]]
        || [viewController isKindOfClass:[BusLineViewController class]] )
    {
        if ( [self getBusStationAndLineCount] >= 10 )
        {
            ...
            if ( [viewController isKindOfClass:[BusStationPOIDetailViewController class]])
           {
            ...
            else if ([viewController isKindOfClass:[BusLineViewController class]])
            {
    ...
    NSLog(@"view count : %d", (int)self.viewControllers.count);
}
...
- (int) getBusStationAndLineCount
{
    ...
    {
        if ( [view isKindOfClass:[BusStationPOIDetailViewController class]] ) count++;
        else if ( [view isKindOfClass:[BusLineViewController class]] ) count++;
    }
    return count;
}
