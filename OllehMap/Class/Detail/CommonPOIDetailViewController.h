...
@protocol CommonPOIDetailViewControllerDelegate;
@class GeneralPOIDetailViewController;
...
@interface CommonPOIDetailViewController : OMParentViewController
<ABNewPersonViewControllerDelegate, UINavigationControllerDelegate, MFMailComposeViewControllerDelegate, UIAlertViewDelegate>
{
    ...
    ParamType _dicType;
    __unsafe_unretained id <CommonPOIDetailViewControllerDelegate> _delegate;
}
