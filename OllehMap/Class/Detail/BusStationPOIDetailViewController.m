//
//  BusStationPOIDetailViewController.m
//  OllehMap
//
...
@interface BusStationPOIDetailViewController ()

@end

@implementation BusStationPOIDetailViewController
...
- (void) busListDraw
{
    ...
    int buslist = (int)[(NSMutableDictionary *)[oms.busStationNewDictionary objectForKeyGC:@"buslane_LIST"] count];
    ...
    NSMutableDictionary *fdic = [OMDatabaseConverter makeFavoriteDictionary:-1
                                                                  sortOrder:-1
                                                                   ...
                                                                   iconType:Favorite_IconType_BusStop
                                                                    ...
                                                                    coord3y:0
                                                                 detailType:@"TR_BUS"
                                                                   detailID:[oms.busStationNewDictionary objectForKeyGC:@"stid"] shapeType:@"" fcNm:@"" idBgm:@"" rdCd:@""];
