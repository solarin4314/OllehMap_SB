...
- (void) viewDidAppear:(BOOL)animated
{
    ...
    if ( _isPublicFirst )
    {
        ...
        if(self.publicIndex != 0)
        {
            _currentPublicMethodListIndex = self.publicIndex - 1;
...
- (void) initComponents
{
    ...
    // 상단 네비게이션 그룹 뷰
    _vwNavigationGroup = [[UIView alloc] initWithFrame:CGRectMake(0, 0 + OM_STARTY, 320, 37)];
    ...
    [_btnNavigationCarButton setImage:[UIImage imageNamed:@"title_2tab_btn1_pressed.png"] forState:UIControlStateHighlighted];
    [_btnNavigationCarButton setImage:[UIImage imageNamed:@"title_2tab_btn1_pressed.png"] forState:UIControlStateHighlighted + UIControlStateSelected];
    ...
    [_btnNavigationPublicButton setImage:[UIImage imageNamed:@"title_2tab_btn2_pressed.png"] forState:UIControlStateHighlighted];
    [_btnNavigationPublicButton setImage:[UIImage imageNamed:@"title_2tab_btn2_pressed.png"] forState:UIControlStateHighlighted + UIControlStateSelected];
    ...
    _vwRoutePathMapContainer = [[UIView alloc]
                                initWithFrame:CGRectMake(0, 37 + OM_STARTY,320,
    ...
    _vwRoutePathListContainer = [[UIView alloc]
                                 initWithFrame:CGRectMake(0, 37 + OM_STARTY,
                                                          320,
                                                          self.view.frame.size.height
                                                          - (74 + OM_STARTY))];
    ...
    _vwBottomButtonGroup = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 37 , 320, 37)];
    ...
    _vwCarRouteSelectorPopup = [[UIView alloc]
                                initWithFrame:CGRectMake(0, 0 + OM_STARTY,
...
- (void) showCarRouteSelector:(id)sender
{
    ...
    // 팝업 메인뷰 생성
    UIView *vwSelectorMain = [[UIView alloc] initWithFrame:CGRectMake(116/2, 202/2, 410/2, 552/2)];
    
    // 배경
    UIImageView *imgvwSelectorMainBack = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"popup_bg.png"]];
    [imgvwSelectorMainBack setFrame:CGRectMake(0, 0, 410/2, 552/2)];
    ...
    // 타이틀 렌더링
    {
        ...
        [titleLbl setText:NSLocalizedString(@"Body_SRRM_RouteSelector_Title", @"")];
        ...
        [titleBtn addTarget:self action:@selector(closeCarRouteSelector:) forControlEvents:UIControlEventTouchUpInside];
        ...
        [vwSelectorMain addSubview:titleView];
    }
    
    // 취소버튼
    UIButton *btnCancel = [[UIButton alloc] initWithFrame:CGRectMake(116/2, 460/2, 176/2, 64/2)];
    [btnCancel setImage:[UIImage imageNamed:@"popup_btn_cancel.png"] forState:UIControlStateNormal];
    [btnCancel setImage:[UIImage imageNamed:@"popup_btn_cancel_pressed.png"] forState:UIControlStateHighlighted];
    ...
    // 실시간빠른길
    {
        UIControl *ctrlRoute = [[UIControl alloc] initWithFrame:CGRectMake(4/2, 62/2, 402/2, 90/2)];
        [ctrlRoute setBackgroundColor:convertHexToDecimalRGBA(@"f4", @"f4", @"f4", 1)];
        ...
        [imgvwChecker setFrame:CGRectMake(20/2, 20/2, 25, 25)];
        [ctrlRoute addSubview:imgvwChecker];
        UILabel *lblRoute = [[UILabel alloc] initWithFrame:CGRectMake(4/2 + 80/2, 30/2, 310/2, 15)];
        ...
        [vwSelectorMain addSubview:vwLine];
        
    }
    // 무료도로
    {
        UIControl *ctrlRoute = [[UIControl alloc] initWithFrame:CGRectMake(4/2, 62/2 + 90/2 + 4/2, 402/2, 90/2)];
        [ctrlRoute setBackgroundColor:convertHexToDecimalRGBA(@"f4", @"f4", @"f4", 1)];
    ...
    // 최단거리
    {
        UIControl *ctrlRoute = [[UIControl alloc] initWithFrame:CGRectMake(4/2, 62/2 + 90/2 + 4/2 + 90/2 + 4/2, 402/2, 90/2)];
    ...
    // 고속(화)도로
    {
        UIControl *ctrlRoute = [[UIControl alloc] initWithFrame:CGRectMake(4/2, 62/2 + 90/2 + 4/2 + 90/2 + 4/2 + 90/2 + 4/2, 402/2, 90/2)];
        ...
        // 라인
        UIImageView *vwLine = [[UIImageView alloc] initWithFrame:CGRectMake(4/2, 62/2 + 90/2 + 4/2 + 90/2 + 4/2 + 90/2 + 4/2 + 90/2, 402/2, 4/2)];
        [vwLine setImage:[UIImage imageNamed:@"popup_list_line.png"]];
        [vwSelectorMain addSubview:vwLine];
...
{
    _currentRouteDetailPathIndex = (int)[(UIControl *)sender tag];
    [self renderCarMap];
}
...
- (void) renderCarMap
{
    ...
    // 지도 컨테이너 뷰 사이즈 교정
    [_vwRoutePathMapContainer setFrame:CGRectMake(0, 37 + OM_STARTY, 320,
                                                  self.view.frame.size.height
                                                  - 74 - OM_STARTY)];
    ...
    NSLog(@"사이즈 : %@", NSStringFromCGRect(_vwRoutePathMapContainer.frame));
...
- (void) renderCarMapPathPolygon
{
    ...
    SetPolylineOverlayStrokeColor(_plovrPath, convertHexToDecimal(@"d4") ,convertHexToDecimal(@"00") ,convertHexToDecimal(@"e7") ,0.8f);
    ...
    SetPolylineOverlayStrokeColor(_plovrWalk1, convertHexToDecimal(@"d4") ,convertHexToDecimal(@"00") ,convertHexToDecimal(@"e7") ,0.8f);
    ...
    SetPolylineOverlayStrokeColor(_plovrWalk2, convertHexToDecimal(@"d4") ,convertHexToDecimal(@"00") ,convertHexToDecimal(@"e7") ,0.8f);
    ...
    SetPolylineOverlayStrokeColor(_plovrWalk3, convertHexToDecimal(@"d4") ,convertHexToDecimal(@"00") ,convertHexToDecimal(@"e7") ,0.8f);
...
- (void) renderCarMapRouteDetailPathInfo:(int)pathIndex
{
    ...
    [_scrollView setFrame:CGRectMake(0, self.view.frame.size.height- 37 - 37 - OM_STARTY - scrollRect.size.height, 320, scrollRect.size.height)];
...
- (void) renderCarMapRouteDetailPathInfoMiddle :(int)pathIndex : (int)viewSight
{
    ...
    if (pathIndex == -1) // 전체경로 일때..
    {
        ...
        [lblTime setText:[NSString stringWithFormat:@"약 %@",[self getTimeRefined:(int)oms.searchRouteData.routeCarTotalTime]]];
...
- (void) renderCarMapRouteSummaryInfo
{
    ...
    // 요약정보 배경
    //UIView *imgvwBackLeft = [[UIView alloc] init];
    //[imgvwBackLeft setBackgroundColor:convertHexToDecimalRGBA(@"1c", @"7f", @"ae", 0.7)];
    ...
    if ( sizeRouteSummaryPathText.width > 219 )
    {
        ...
        {
            for (int i =1, maxi=(int)[(NSArray *)startAddressComponents count]; i < maxi; i++)
            {
        ...
        {
            for (int i =1, maxi=(int)[(NSArray *)destAddressComponents count]; i < maxi; i++)
            {
...
- (void) renderCarListRouteSummaryInfo
{
    ...
    [vwCarRouteSummaryInfo setBackgroundColor:[UIColor whiteColor]];
    ...
    else
    {
        ...
        UIView *vwMarqueeContainer = [[UIView alloc] initWithFrame:CGRectMake(10, 10, rectCarRouteSummaryInfoPath.size.width*2 + 50, 15)];
    ...
    UIImageView *imgvwCarRouteSummaryInfoBackLeft = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"info_align_bg_01.png"]];
    ...
    UIImageView *imgvwCarRouteSummaryInfoBackRight = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"info_align_bg_02.png"]];
...
- (void) renderPublicSelectorCategoryTab
{
    ...
    {
        // marquee 용 라벨 2개를 포함하는 뷰 생성
        UIView *vwMarqueeContainer = [[UIView alloc] initWithFrame:CGRectMake(10, 10, rectRoutePathLabel.size.width*2 + 50, 15)];
    ...
    // 배경+마스크 이미지
    UIImageView *imgvwRoutePathInfoBack = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"info_align_bg_01.png"]];
    [imgvwRoutePathInfoBack setFrame:CGRectMake(0, 0, 320, 35)];
    [vwRoutePathInfo insertSubview:imgvwRoutePathInfoBack atIndex:0];
    
    UIImageView *imgvwRoutePathInfoMask1 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"car_align_bg_01_list_mask.png"]];
    [imgvwRoutePathInfoMask1 setFrame:CGRectMake(0, 0, 10, 35)];
    [vwRoutePathInfo addSubview:imgvwRoutePathInfoMask1];
    
    UIImageView *imgvwRoutePathInfoMask2 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"car_align_bg_01_list_mask.png"]];
...
- (void) renderPublicSelectorRouteMethodListTable
{
    ...
    for (NSDictionary *resultDic in arrRoutePublic)
    {
        ...
        [lblTime setBackgroundColor:[UIColor clearColor]];
        @try { [lblTime setText:[NSString stringWithFormat:@"약 %@", [self getTimeRefined:(int)[[routeDic objectForKeyGC:@"TotalTime"] intValue]]]]; }
...
- (void) onPublicMethod :(id)sender
{
    ...
    _currentPublicMethodListIndex = (int)vwCell.tag;
    _currentRouteDetailPathIndex = -1;
    [self renderPublicList];
}
...
- (void) renderPublicListRouteSummaryInfo
{
    ...
    UIImageView *imgvwPublicRouteSummaryInfoBack = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"info_align_bg_01.png"]];
        ...
        && [[[routeDic objectForKeyGC:@"RouteGate"] allKeys] containsObject:@"Gates"])
    {
        ...
        for (int count=0, maxCount=(int)[(NSMutableDictionary *)[[routeDic objectForKeyGC:@"RouteGate"] objectForKeyGC:@"Gates"] count]-1; count<=maxCount; count++)
        {
    ...
    NSString *strTime = [NSString stringWithFormat:@"약 %@", [self getTimeRefined:(int)timeDoubleValue]];
...
- (void) onPublicListRouteDetailPathTableToMap :(id)sender
{
    ...
    // 현재 선택 인덱스 저장
    _currentRouteDetailPathIndex = (int)vwCell.tag;
    
    // 지도모드 렌더링
    [self renderPublicMap];
    // 지도모드 렌더링 이후 상세경로정보 재설정
    [self renderPublicMapRouteDetailPathInfo:(int)vwCell.tag];
...
- (void) renderPublicMapPathPolygon
{
    ...
    for (int methodCnt=0, methodMaxCnt=(int)[(NSArray *)methodList count]; methodCnt<methodMaxCnt; methodCnt++)
        //for (NSDictionary *methodDic in methodList)
    {
        ...
        CoordList *coordListMethod = [[CoordList alloc] init];
        for (int cnt=0, maxcnt=(int)[(NSArray *)vertexs count]; cnt<maxcnt; cnt++)
            //for (NSValue *vertexValue in vertexs)
        {
            ...
            {
                CoordList *coords = [[CoordList alloc] init];
    ...
    if (stations.count > 0)
    {
        CoordList *coordListWalkStart = [[CoordList alloc] init];
        ...
        CoordList *coordListWalkDest = [[CoordList alloc] init];
    ...
    for (CoordList *clw in routeMethodContainer)
    {
        ...
        SetPolylineOverlayStrokeColor(plovr, convertHexToDecimal(@"d4") ,convertHexToDecimal(@"00") ,convertHexToDecimal(@"e7") ,0.8f);
...
- (void) renderPublicMapRouteDetailPathInfo:(int)pathIndex
{
    ...
    [_scrollViewPub setFrame:CGRectMake(0, self.view.frame.size.height-37-37-OM_STARTY-detailRect.size.height, 320, detailRect.size.height)];
...
- (void) renderPublicMapRouteDetailPathInfoMiddle:(int)pathIndex :(int)viewSight
{
    ...
    if (pathIndex == -1)
    {
        ...
        [lblTime setTextColor:convertHexToDecimalRGBA(@"2F", @"C9", @"EB", 1.0f)];
        [lblTime setBackgroundColor:[UIColor clearColor]];
        [lblTime setText:[NSString stringWithFormat:@"약 %@",[self getTimeRefined:(int)[[routeGateDic objectForKeyGC:@"TotalTime"] doubleValue]]]];
    ...
    if(viewSight == 320)
    {
        ...
        rectPublicRouteDetailPath.origin.y = _vwRoutePathMapContainer.frame.size.height - rectPublicRouteDetailPath.size.height -OM_STARTY;
...
- (NSString*) getTimeRefined :(int) time
{
    // 총소요시간이 시간단위를 넘어갈 경우
    if (time >= 60)
    {
        ...
        hour = time / 60;
        minute = time - (hour * 60);
        return [NSString stringWithFormat:@"%d시간 %d분", hour, minute];
    }
    ...
    else
    {
        ...
        return [NSString stringWithFormat:@"%d분", time];
    }
}
...
{
    int baseFare = 3000;
    int distanceFare = (int)((distance - 2000)/142) * 100;
    int totalFare;
    if (distanceFare > 0)
    {
        // localCode  를 지역코드 대신 분으로 사용하고 있음.. (분*100원씩.. 추가요금)
        // 거리요금 반영안함
        //totalFare = baseFare + distanceFare + ((localCode * 60 / 35)*100);
