...
// ==========================================
// ******************************************
@property (nonatomic, assign) int publicIndex;
@property (nonatomic, assign) BOOL isPublicFirst;
@property (nonatomic, assign) int currentRouteCarSelector;
@property (nonatomic, assign) OM_SRRMV_PublicMethodType currentPublicMethod;
