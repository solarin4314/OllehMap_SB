...
// 검색결과 라인 POI를 처리하기위한 오버레이 클래스를 정의한다. :: 커스텀 이미지 오버레이 클래스를 상속받는다.
@interface OMImageOverlayLineSingle : OMImageOverlaySearchSingle
{
    BOOL _lineUsePOIIcon;
    int _lineCoordY;
}
@property (nonatomic, assign) BOOL lineUsePOIIcon;
@end
